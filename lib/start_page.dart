...
class StartPageState extends State<StartPage> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    rabbitController = AnimationController(vsync: this, duration: const Duration(seconds: 1));
          ...
          children: [
            Align(
              child: Padding(
                ...
                child: Image.asset("assets/campus.png", color: Colors.green,),
              ),
            ),
            Positioned(
                ...
                children: [
                  Padding(
                    ...
                    child: SlideTransition(
                      position: rabbitController.drive(
                        CurveTween(curve: Curves.easeInOut)
                      ).drive(
                        Tween(begin: const Offset(0,-0.05), end: const Offset(0, 0.05))
                      ),
                      child: Image.asset("assets/rabbit_title.png", height: 300,)),
                  ),
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: PyonButton(text: "スタート", onPressed: () {
                      Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (_) => const GameView()));
                    },)
                  ),
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: PyonButton(text: "ライセンス", onPressed: () {
