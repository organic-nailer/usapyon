...
final List<PreviewStageData> stage1 = [
  ...
  const PreviewStageData(PreviewStageItem.cloudStep, 95, 17),
];
...
final List<PreviewStageData> stage2 = [
  ...
  const PreviewStageData(PreviewStageItem.cloudStep, 36, 9),
...
final List<PreviewStageData> stage3 = [
  ...
  const PreviewStageData(PreviewStageItem.cloudStep, 65, 15),
  const PreviewStageData(PreviewStageItem.cloudStep, 78, 2),
...
final List<PreviewStageData> stage4 = [
  ...
  const PreviewStageData(PreviewStageItem.cloudStep, 36, 17),
  ...
  const PreviewStageData(PreviewStageItem.cloudStep, 70, 8),
  ...
  const PreviewStageData(PreviewStageItem.cloudStep, 92, 14),
];
...
final List<PreviewStageData> stage5 = [
  ...
  const PreviewStageData(PreviewStageItem.cloudStep, 85, 19),
...
final List<PreviewStageData> stage7 = [
  ...
  const PreviewStageData(PreviewStageItem.cloudStep, 56, 1),
  const PreviewStageData(PreviewStageItem.cloudStep, 65, 13),
...
final List<PreviewStageData> stage8 = [
  ...
  const PreviewStageData(PreviewStageItem.cloudStep, 94, 9),
];
...
final List<PreviewStageData> stage9 = [
  ...
  const PreviewStageData(PreviewStageItem.cloudStep, 80, 13),
...
final List<PreviewStageData> stage10 = [
  ...
  const PreviewStageData(PreviewStageItem.cloudStep, 20, 0),
  const PreviewStageData(PreviewStageItem.cloudStep, 29, 19),
